   ...
   class BSSDK
    {
        ...
        [DllImport("BS_SDK.dll",
             CharSet = CharSet.Ansi,
             EntryPoint = "BS_OpenUSB")]
        public static extern int BS_CloseUSB(int handle); 
        #endregion 
        // AGREGADO POR JP Y LEO
        ...
        public static extern int BS_EnrollUserDStation(int handle, IntPtr userHdr, byte[] templateData, byte[] faceTemplate);
